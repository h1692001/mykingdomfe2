...
const UpdateProduct = () => {
    ...
    const createProduct = async () => {
        try {
            ...
            setIsLoading(false);
            Swal.fire("Success", "Update Product Successfully", 'success')
            setNewProduct({
            });
        ...
        <Spin spinning={isLoading}>
            <div style={{ margin: '0 20px' }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-around", gap: '30px' }}>
                    ...
                    <div style={{ marginTop: '20px', width: "100%" }}>
                        <p style={{ marginBottom: '10px', fontWeight: '500', fontSize: '16px' }}>Ẩn khỏi giao diện</p>
                        <Select

                            placeholder="Chọn"
                            optionFilterProp="children"
                            onChange={(value) => { setNewProduct({ ...newProduct, isHidden: value }) }}
                            options={[
                                {
                                    label: 'Ẩn',
                                    value: true
            ...
            <div style={{ marginTop: '20px', padding: '0 20px', display: 'flex', justifyContent: 'end' }}>
                ...
                }} onClick={() => { createProduct() }}>Cập nhật</Button>
            </div>
        </Spin>
    </>
}
